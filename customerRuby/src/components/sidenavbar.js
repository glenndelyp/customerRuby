          ...
          <div className="flex flex-col justify-start items-center space-y-4">
            ...
            {/* Logout Button */}
             ...
             <button 
                ...
                className="w-full flex justify-start items-center gap-4 pl-5 border border-gray-200 hover:bg-gray-900 p-2 rounded-md group cursor-pointer hover:shadow-lg"
              >
